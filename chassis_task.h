...
//add some define
#define M3508_RATIO      19     //wheel ratio
#define RADIUS           0.6f          //wheel diameter m
#define WHEEL_PERIMETER  1000.0f          //gear circumference
...
#define CHASSIS_GM6020_MOTOR1_ECD_OFFSET 3342
#define CHASSIS_GM6020_MOTOR2_ECD_OFFSET 7551
#define CHASSIS_GM6020_MOTOR3_ECD_OFFSET 722
#define CHASSIS_GM6020_MOTOR4_ECD_OFFSET 695
...
//chassis GM6020 motor speed-closed PID
#define GM6020_MOTOR_SPEED_PID_KP 500.0f
#define GM6020_MOTOR_SPEED_PID_KI 0.1f
#define GM6020_MOTOR_SPEED_PID_KD 0.0f

#define GM6020_MOTOR_SPEED_PID_MAX_OUT   30000.0f
#define GM6020_MOTOR_SPEED_PID_MAX_IOUT  5000.0f

//define chassis GM6020 motor relative-angle-closed PID
#define GM6020_MOTOR_ENCODE_RELATIVE_PID_KP 25.0f
#define GM6020_MOTOR_ENCODE_RELATIVE_PID_KI 0.1f
#define GM6020_MOTOR_ENCODE_RELATIVE_PID_KD 0.0f

#define GM6020_MOTOR_ENCODE_RELATIVE_PID_MAX_OUT   10.0f
#define GM6020_MOTOR_ENCODE_RELATIVE_PID_MAX_IOUT  0.001f
...
//the mini gimbal_motor_t version
typedef struct
{
    const motor_measure_t *GM6020_motor_measure;
    GM6020_PID_t GM6020_motor_relative_angle_pid;  //relative-angle-closed PID
    pid_type_def GM6020_motor_gyro_pid;            //speed-closed PID
...
typedef struct
{
  ...
  chassis_motor_t motor_chassis[4];          //chassis driving motor data.
  gm6020_motor_t motor_steer[4];             //chassis steer motor data.
  ...
  fp32 dirct[4];                    //add driving wheel direction
